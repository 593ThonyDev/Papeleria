...
<html lang="en">
    ...
    <body>
        ...
        <main id="main" class="main">
            <div class="col-lg-12">
                <a href="Productos?accion=nuevo" class="btn btn-primary rounded-pill mb-3">Nuevo registro</a>
                <div class="card">
                            ...
                            <table id="example" class="display table header-border verticle-middle" style="min-width: 845px">
                                ...
                                <tbody>
                                    <%
                                        ...
                                        List<producto> listCh = daoCh.getAll();
                                    ...
                                    <tr>                                                    
                                        <td class="d-flex justify-items-center p-4"> 
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <div>
                                                    <a href="Productos?accion=editar&idProducto=<%= ch.getIdProducto()%>" class="dropdown-item"><i class="fas fa-pencil-alt text-primary"></i>&nbsp; Actualizar</a>
                                                </div>
                                                <div class="dropdown-divider"></div>
                                                <div>
                                                    <a href="Productos?accion=eliminar&idProducto=<%= ch.getIdProducto()%>" class="dropdown-item"><i class="fas fa-arrow-circle-down text-secondary"></i>&nbsp; Eliminar</a>
                                                </div>
                                                <div class="dropdown-divider"></div>
                                            </div>
                                        </td>	                                               
                                        <td class="text-center text-muted"><%= ch.getProNombre()%></td>                                          
                                        <td class="text-center text-muted"><%= ch.getProCodigo()%></td>                                          
                                        <td class="text-center text-muted"><%= ch.getProStock()%></td>                                          
                                        <td class="text-center text-muted"><%= ch.getProPrecio()%></td>                                          
                                    </tr>   
                                    <%}%>
                                </tbody>
                            </table>
