                        ...
                        <div class="row">
                            <div class="col-xl-6 mb-3">
                                <div class="example">
                                    ...
                                    <input class="form-control" type="text" required="true" name="proNombre">
                                </div>
                            </div>
                            <div class="col-xl-6 mb-3">
                                <div class="example">
                                    <p class="mb-1 text-primary">Codigo:</p>
                                    <input type="text" class="form-control" required="true" name="proCodigo">
                                </div>
                            </div>                                            
                        </div>                                                                     
                        <div class="row">                            
                            <div class="col-xl-6 mb-3">
                                <div class="example">
                                    ...
                                    <input type="number"  class="form-control" maxlength="10"  required="true" name="proStock" >
                                </div>
                            </div>      
                            <div class="col-xl-6 mb-3">
                                <div class="example">
                                    <p class="mb-1 text-primary">Precio:</p>
                                    <input class="form-control" type="decimal" required="true" name="proPrecio" >
                                </div>
                            </div>
                        </div>                                                                                                                                                         
                    </div>
