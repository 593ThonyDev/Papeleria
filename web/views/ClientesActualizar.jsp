            ...
            <div class="card p-3">
                <form method="post" action="Clientes">
                    <%
                        ...
                        cliente cli = (cliente)dao.getById(id);
                    %>
                        ...
                        <div class="row">
                            <div class="col-xl-6 mb-3">
                                <div class="example">
                                    ...
                                    <input class="form-control" type="hidden" required="true" name="idCliente" value="<%= cli.getIdCliente()%>">
                                    <input class="form-control" type="text" required="true" name="cliNombre" value="<%= cli.getCliNombre()%>">
                                </div>
                            </div>
                            <div class="col-xl-6 mb-3">
                                <div class="example">
                                    <p class="mb-1 text-primary">Apellidos:</p>
                                    <input type="text" class="form-control" required="true" name="cliApellido" value="<%= cli.getCliApellido()%>">
                                </div>
                            </div>                                            
                        </div>                                                                     
                        <div class="row">                            
                            <div class="col-xl-6 mb-3">
                                <div class="example">
                                    <p class="mb-1 text-primary">Cedula:</p>
                                    <input type="number"  class="form-control" maxlength="10"  required="true" name="cliCedula" value="<%= cli.getCliCedula()%>">
                                </div>
                            </div>      
                            <div class="col-xl-6 mb-3">
                                <div class="example">
                                    <p class="mb-1 text-primary">Email:</p>
                                    <input class="form-control" type="email" required="true" name="cliEmail" value="<%= cli.getCliEmail()%>">
                                </div>
                            </div>
                        </div>                                                                     
                        <div class="row">                            
                            <div class="col-xl-6 mb-3">
                                <div class="example">
                                    ...
                                    <input type="tel" maxlength="11" class="form-control" required="true" name="cliTelefono" value="<%= cli.getCliTelefono()%>">
                                </div>
                            </div>                                            
                        </div>                                                                                                                                                            
                    </div>
