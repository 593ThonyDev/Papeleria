            ...
            <div class="card p-3">
                <form method="post" action="Productos">
                    <%
                        ...
                        producto cli = (producto)dao.getById(id);
                    %>
                        ...
                        <div class="row">
                            <div class="col-xl-6 mb-3">
                                <div class="example">
                                    ...
                                    <input class="form-control" type="text" required="true" name="proNombre" value="<%= cli.getProNombre()%>">
                                    <input class="form-control" type="hidden" required="true" name="idProducto" value="<%= cli.getIdProducto()%>">
                                </div>
                            </div>
                            <div class="col-xl-6 mb-3">
                                <div class="example">
                                    <p class="mb-1 text-primary">Codigo:</p>
                                    <input type="text" class="form-control" required="true" name="proCodigo" value="<%= cli.getProCodigo()%>">
                                </div>
                            </div>                                            
                        </div>                                                                     
                        <div class="row">                            
                            <div class="col-xl-6 mb-3">
                                <div class="example">
                                    ...
                                    <input type="number"  class="form-control" maxlength="10"  required="true" name="proStock" value="<%= cli.getProStock()%>">
                                </div>
                            </div>      
                            <div class="col-xl-6 mb-3">
                                <div class="example">
                                    <p class="mb-1 text-primary">Precio:</p>
                                    <input class="form-control" type="decimal" required="true" name="proPrecio" value="<%= cli.getProPrecio()%>">
                                </div>
                            </div>
                        </div>                                                                                                                                                         
                    </div>
